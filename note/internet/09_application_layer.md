...
また、**検索エンジン**を使うことで広大な[インターネット](./01_basic_knowledge_of_network.md#インターネット)上の情報に容易にアクセスすることができる。
...
**H.323**は[IP](./07_internet_layer.md#ip)ネットワーク上で音声や映像をやり取りするための[プロトコル](./01_basic_knowledge_of_network.md#プロトコル)体系。
